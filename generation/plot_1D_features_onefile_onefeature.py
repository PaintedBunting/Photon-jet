...
myfile = TFile("axion1_100GeV_20k.root")
...
#just uncomment whichever feature you want to graph

#zsegmentation.Draw()

#gPad.SetLogz() #uncomment this if you want to see any of the following features
...
gPad.SetLogz(0) #uncomment this if you want to see any of the following features
