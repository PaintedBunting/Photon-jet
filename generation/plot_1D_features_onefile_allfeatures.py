...
myfile = TFile("gamma_100GeV_20k.root")
#or other file that you want to use. 
mytree = myfile.Get("fancy_tree")

c = TCanvas("a","a",520, 6120) #9 pads 500 pixels each, added 36 percent border betweeen = 6120 total height

#setting up pads for all the feature graphs
c.Divide(1, 9, 0.02, 0.01)
one = c.cd(1)
two = c.cd(2)
three = c.cd(3)
four = c.cd(4)
